...
public class CompTransactionController {
     ...
     */
    @GetMapping
    public ResponseEntity<List<CompTransactionResDTO>> getTransactions(@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
        ...
        List<CompTransaction> transactions = compTransactionService.findTransactions(startDate, endDate, status, username, nickname, userIp, principal);
