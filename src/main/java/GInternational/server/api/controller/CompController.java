...
import GInternational.server.api.service.CompService;
...
public class CompController {
     ...
     */
    @PostMapping("/users/comp/apply")
    public ResponseEntity<?> applyForComp(HttpServletRequest request,
                                          Authentication authentication) {
        PrincipalDetails principal = (PrincipalDetails) authentication.getPrincipal();
        try {
            CompResponseDTO responseDTO = compService.applyForRolling(principal, request);
